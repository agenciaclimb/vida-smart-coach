...
-- ==========================================
-- Sistema completo de Loja de Recompensas
...
-- ==========================================
-- TESTE: Inserir recompensas de exemplo
-- ==========================================

INSERT INTO public.rewards (title, description, category, xp_cost, stock_quantity, partner_name, image_url) VALUES
('Consulta Nutricional Gratuita', 'Uma consulta com nutricionista parceiro para ajustar seu plano alimentar', 'servico', 5000, 10, 'Clínica Vida Saudável', 'https://images.unsplash.com/photo-1505576399279-565b52d4ac71?w=400'),
('E-book: 30 Receitas Saudáveis', 'Receitas práticas e nutritivas para seu dia a dia', 'digital', 1000, NULL, 'Vida Smart', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'),
('10% OFF em Suplementos', 'Cupom de 10% de desconto em produtos selecionados', 'desconto', 2000, 50, 'Loja VidaSupp', 'https://images.unsplash.com/photo-1584464491033-06628f3a6b7b?w=400'),
('Aula de Yoga Online', 'Acesso a 1 mês de aulas de yoga ao vivo', 'experiencia', 3000, 20, 'Yoga Flow Studio', 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400'),
('Garrafa Térmica Premium', 'Garrafa térmica de 1L com isolamento a vácuo', 'produto', 4000, 15, 'FitGear', 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=400')
ON CONFLICT DO NOTHING;

-- Verificar recompensas criadas
SELECT * FROM public.v_rewards_catalog LIMIT 5;
