...
begin
  if not exists (
    ...
    where schemaname='public' and tablename='daily_activities' and policyname='Users can view own activities'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='daily_activities' and policyname='Users can insert own activities'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='daily_activities' and policyname='Users can update own activities'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='leaderboards' and policyname='Allow public read access on leaderboards'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='daily_missions' and policyname='Users can view own missions'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='daily_missions' and policyname='Users can update own missions'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='gamification_events' and policyname='Allow public read access on events'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='user_event_participation' and policyname='Users can view own participation'
  ) then
