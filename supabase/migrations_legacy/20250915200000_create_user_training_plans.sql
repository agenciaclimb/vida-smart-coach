...
begin
  if not exists (
    ...
    where schemaname='public' and tablename='user_training_plans' and policyname='Users can view own training plans'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='user_training_plans' and policyname='Users can insert own training plans'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='user_training_plans' and policyname='Users can update own training plans'
  ) then
...
begin
  if not exists (
    select 1 from pg_policies
    where schemaname='public' and tablename='user_training_plans' and policyname='Users can delete own training plans'
  ) then
