...
// Skeletons
import HeroGamificationSkeleton from '@/components/dashboard/skeletons/HeroGamificationSkeleton';
import WeeklySummarySkeleton from '@/components/dashboard/skeletons/WeeklySummarySkeleton';
import ActionCardsSkeleton from '@/components/dashboard/skeletons/ActionCardsSkeleton';
import CheckinCTASkeleton from '@/components/dashboard/skeletons/CheckinCTASkeleton';
...
const DashboardTab = () => {
  ...
  const { weeklyData, hasPlans, loading: statsLoading, preferredTime } = useDashboardStats();
  ...
  return (
    ...
    >
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">
              {(() => {
                ...
                if (hour < 12) return 'Bom dia! Pronto para começar o dia com energia?';
                if (hour < 18) return 'Boa tarde! Vamos continuar sua jornada de evolução?';
      ...
      {gamLoading ? (
        <HeroGamificationSkeleton />
      ) : (
        gamificationData && <HeroGamification gamificationData={gamificationData} />
      )}
  ...
  {statsLoading ? <WeeklySummarySkeleton /> : <WeeklySummary weeklyData={weeklyData} />}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <ActionCard
          ...
          ariaLabel="Abrir chat com IA Coach"
        />
        <ActionCard
          icon={<ClipboardList />}
          title="Meu Plano"
